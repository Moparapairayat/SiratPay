            ...
            ?>
                    ...
                    <div class="card-body text-center pb-0">
                        <div class="secure-badge-container">
                            ...
                            <h3 class="mb-1 text-dark fw-bold" style="font-size: 1.35rem;"><?php echo htmlspecialchars($data['paymentLink']['product']['title']);?></h3>
                            <?php if(!empty($data['paymentLink']['product']['description'])): ?>
                                <p class="text-secondary small mb-2"><?php echo htmlspecialchars($data['paymentLink']['product']['description']);?></p>
                            <?php endif; ?>
