...
<head>
    ...
    <style>
        /* ================================================================
           SIRATPAY — "NEXORA OS" GREEN BRAND SYSTEM
           Nexora OS-inspired premium design language for SiratPay
        ================================================================ */
        ...
        :root {
            ...
            /* ---- Nexora OS Signature Palette ---- */
            --pp-brand-a:         #a3e635;   /* Neon Lime */
            --pp-brand-b:         #22c55e;   /* Emerald Green */
            --pp-brand-c:         #15803d;   /* Darker Forest Accent */
            --pp-brand-gradient:  linear-gradient(135deg, #22c55e 0%, #a3e635 100%);
            --pp-brand-glow:      rgba(163, 230, 53, 0.25);

            /* Sidebar */
            --pp-sidebar-width:   268px;
            --pp-sidebar-bg:      #05120d;   /* Deep Forest Black */
            --pp-sidebar-bg2:     #0b241a;   /* Forest Dark Green */
            --pp-sidebar-border:  rgba(34, 197, 94, 0.12);
            --pp-sidebar-text:    rgba(180, 215, 195, 0.72);
            --pp-sidebar-hover:   rgba(34, 197, 94, 0.08);
            --pp-sidebar-section: rgba(163, 230, 53, 0.45);
        ...
        ================================================== */
        #sidebarMenu {
            max-width: var(--pp-sidebar-width);
            width: 100%;
            background: linear-gradient(175deg, var(--pp-sidebar-bg) 0%, var(--pp-sidebar-bg2) 100%);
        ...
        /* Subtle brand glow line on sidebar top */
        #sidebarMenu::before {
            content: '';
            position: absolute;
        ...
        #sidebarMenu li.nav-item a::after {
            content: '';
            position: absolute;
            inset: 0;
        ...
        #sidebarMenu li.nav-item a:hover::after {
            transform: translateX(100%);
        }

        #sidebarMenu li.nav-item a:hover {
            background: var(--pp-sidebar-hover);
            color: #ffffff;
            transform: translateX(4px);
        }

        #sidebarMenu li.nav-item a.active {
            background: rgba(34, 197, 94, 0.15) !important;
            color: var(--pp-brand-a) !important;
            border: 1px solid rgba(163, 230, 53, 0.35);
            box-shadow: inset 0 0 12px rgba(163, 230, 53, 0.1);
            transform: none;
        }
        ...
        #sidebarMenu li.nav-item a:hover .nav-link-icon,
        #sidebarMenu li.nav-item a.active .nav-link-icon {
            opacity: 1;
        }
        ...
        #sidebarMenu li.card-title {
            ...
            color: var(--pp-sidebar-section);
            margin-bottom: 2px;
            padding-top: 20px !important;
        }

        /* Brand selector dropdown */
        #sidebarMenu .nav-item.dropdown .nav-link {
            color: rgba(220, 255, 230, 0.88) !important;
        ...
        #sidebarMenu .nav-item.dropdown .nav-link:hover {
            background: rgba(34, 197, 94, 0.15);
            border-color: rgba(163, 230, 53, 0.35);
        }

        #sidebarMenu .nav-item.dropdown .text-black  { color: rgba(220, 255, 230, 0.88) !important; }
        #sidebarMenu .nav-item.dropdown .text-secondary { color: rgba(163, 230, 53, 0.75) !important; }

        /* Scrollbar */
        #sidebarMenu::-webkit-scrollbar { width: 3px; }
        ...
        .navbar-brand img {
            filter: drop-shadow(0 2px 4px rgba(34, 197, 94, 0.06));
        ...
        .navbar-toggler-icon {
            filter: invert(36%) sepia(85%) saturate(350%) hue-rotate(92deg) brightness(90%) contrast(90%);
        }
        ...
        .card {
            ...
            border: 1px solid rgba(108,43,217,0.07) !important;
            box-shadow: 0 2px 16px rgba(108,43,217,0.06) !important;
        }

        /* ==================================================
           FORM FOCUS — brand color ring
        ================================================== */
        .form-control:focus,
        .form-select:focus {
            border-color: var(--pp-brand-a) !important;
            box-shadow: 0 0 0 0.2rem rgba(108,43,217,0.15) !important;
        }

        .is-focused .choices__inner,
        .is-open .choices__inner {
            border-color: var(--pp-brand-a);
            box-shadow: 0 0 0 .2rem rgba(108,43,217,0.15);
        }
        ...
        ================================================== */
        .btn-primary {
            background: var(--pp-brand-gradient) !important;
            border: none !important;
            box-shadow: 0 4px 14px var(--pp-brand-glow) !important;
            transition: transform 0.15s ease, box-shadow 0.15s ease !important;
        }

        .btn-primary:hover {
            transform: translateY(-2px) !important;
            box-shadow: 0 8px 22px var(--pp-brand-glow) !important;
        }

        /* ==================================================
           CHOICES.JS
        ================================================== */
        .choices { font-size: .875rem; font-weight: 400; }
        ...
        .choices__list--single { padding: 0.8px; }
        ...
        .choices__list[aria-expanded] { z-index: 3; }
        ...
        /* ---- Custom Sidebar Nexora Brand Widget ---- */
        .pp-sidebar-brand-block {
        ...
        /* Nexora Style Workspace Profile Card */
        ...
        .pp-sidebar-profile-card:hover {
            background: rgba(34, 197, 94, 0.08) !important;
            border-color: rgba(163, 230, 53, 0.3) !important;
        }

        .pp-profile-avatar-circle {
            width: 38px;
            height: 38px;
            border-radius: 50%;
            ...
            box-shadow: 0 4px 10px rgba(163, 230, 53, 0.2);
        }

        .pp-profile-status-dot {
            width: 6px;
            height: 6px;
            border-radius: 50%;
            background: #22c55e;
        ...
        /* Stagger fade for all page-level cards */
        .page-wrapper .card {
    ...
    <div class="page">
        ...
        <div class="offcanvas-md offcanvas-start sidebar" tabindex="-1" id="sidebarMenu">
          ...
          <div class="offcanvas-body p-0">
            <!-- Custom Nexora OS style Sidebar Brand Block -->
            <div class="pp-sidebar-brand-block d-none d-md-flex">
                <div class="pp-sidebar-brand-icon">
                ...
                <div class="pp-sidebar-brand-text">
                    <span class="pp-sidebar-brand-title">SIRATPAY</span>
                </div>
            </div>

            <ul class="nav w-100 flex-column gap-2">

              <!-- Nexora style Brand Selector Profile Card -->
              <div class="nav-item dropdown">
                <a href="#" class="pp-sidebar-profile-card" data-bs-toggle="dropdown" aria-label="Open user menu" aria-expanded="false">
                  <div class="pp-profile-avatar-circle">
                      <?php echo getNameChars($global_response_brand['response'][0]['identify_name'], 1);?>
                  </div>
                  <div class="ps-3 w-100 text-start">
                    <div class="text-white fw-bold" style="font-size: 0.85rem; width: 130px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; display: block;"><?php echo $global_response_brand['response'][0]['identify_name'];?></div>
                    <div>
                        <span class="pp-profile-status-badge">
                            <span class="pp-profile-status-dot"></span>Active brand
                        </span>
                    </div>
                  </div>
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="rgba(255,255,255,0.6)" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="ms-auto"><polyline points="6 9 12 15 18 9"/></svg>
                </a>
                    ...
                    <div class="row text-center align-items-center flex-row-reverse">
                        <div class="col-lg-auto ms-lg-auto">
                            <ul class="list-inline list-inline-dots mb-0">
                                <li class="list-inline-item"><a href="https://help.siratpay.com/" target="_blank" class="link-secondary" rel="noopener">Documentation</a></li>
                                <li class="list-inline-item"><a href="https://github.com/siratpay" target="_blank" class="link-secondary">Modules</a></li>
                            </ul>
                        </div>
                        <div class="col-12 col-lg-auto mt-3 mt-lg-0">
                            <ul class="list-inline list-inline-dots mb-0">
                                <li class="list-inline-item">
                                    © <?php echo date('Y');?>
                                    <a href="https://siratpay.com/" class="link-secondary" target="blank">SiratPay</a>. All rights reserved.
                                </li>
                                <li class="list-inline-item">
                                    <a href="https://updates.siratpay.com/?version=<?php echo $piprapay_current_version['version_code'];?>" class="link-secondary" target="blank"target="blank"> <?php echo $piprapay_current_version['version_name'];?> </a>
                                </li>
                            </ul>
                        </div>
                    </div>
